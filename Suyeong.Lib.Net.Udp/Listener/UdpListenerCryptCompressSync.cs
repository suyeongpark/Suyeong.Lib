...
{
    public class UdpListenerCryptCompressSync
    {
        UdpClient listener;
        byte[] key, iv;
        bool listenOn;

        public UdpListenerCryptCompressSync(int portNum, byte[] key, byte[] iv)
        {
    ...
    public class UdpListenerCryptCompressSyncs : List<UdpListenerCryptCompressSync>
    {
