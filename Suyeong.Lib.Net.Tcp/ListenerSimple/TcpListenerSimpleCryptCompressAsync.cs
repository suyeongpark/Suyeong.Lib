...
{
    public class TcpListenerSimpleCryptCompressAsync
    {
        TcpListener listener;
        byte[] key, iv;

        public TcpListenerSimpleCryptCompressAsync(int portNum, byte[] key, byte[] iv)
        {
            this.key = key;
            this.iv = iv;
        ...
        ~TcpListenerSimpleCryptCompressAsync()
        {
            this.listener.Stop();
        }
    ...
    public class TcpListenerCryptCompressAsyncs : List<TcpListenerSimpleCryptCompressAsync>
    {
